    ...
    <form autocomplete="off" name="form1" class="col s12" action="save.php" method="post">
        <div class="col s12">
            ...
            <div class="row">
                ...
                <div class="input-field col s2">
                    <input type="text" required id="autocomplete-input" name="tipo" class="tipo">
            ...
            <div class="row">
                ...
                <div class="input-field col s2">
                    <input type="text" required id="autocomplete-input" name="contato" class="contato">
                    <label for="autocomplete-input">Contato</label>
                </div>
                <div class="input-field col s2">
                    <input type="text" required id="autocomplete-input" name="solicitacao" class="solicitacao">
                    <label for="autocomplete-input">Solicitação</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s3">
                    <input type="text" required id="autocomplete-input" name="motivo" class="motivo">
                    <label for="autocomplete-input">Motivo</label>
                </div>
                <div class="input-field col s4">
                    <input type="text" required id="autocomplete-input" name="contrato" class="contrato">
                    <label for="autocomplete-input">Contrato</label>
                </div>
                <div class="input-field col s2">
                    <input type="text" required id="autocomplete-input" name="agendamento" class="agendamento">
...
<script type='text/javascript'>
    ...
    // Auto Complete do Tipo
    $(document).ready(function(){
        $('input.tipo').autocomplete({
            data: {
                <?php $formManager->autocompleteForm($tipos,'getTipo');?>
            },
        });
    });

    // Auto Complete do Contato
    $(document).ready(function(){
        $('input.contato').autocomplete({
            data: {
                <?php $formManager->autocompleteForm($contatos,'getContato');?>
            },
        });
    });

    // Auto Complete da Solicitação
    $(document).ready(function(){
        $('input.solicitacao').autocomplete({
            data: {
                <?php $formManager->autocompleteForm($solicitacaos,'getSolicitacao');?>
            },
        });
    });

    // Auto Complete do Motivo
    $(document).ready(function(){
        $('input.motivo').autocomplete({
            data: {
                <?php $formManager->autocompleteForm($motivos,'getMotivo');?>
            },
        });
    });

    // Auto Complete do Contrato
    $(document).ready(function(){
        $('input.contrato').autocomplete({
            data: {
                <?php $formManager->autocompleteForm($contratos,'getContrato');?>
            },
        });
    });

    // Auto Complete do Agendamento
    $(document).ready(function(){
        $('input.agendamento').autocomplete({
            data: {
                <?php $formManager->autocompleteForm($agendamentos,'getAgendamento');?>
            },
        });
    });
