...
<head>
    ...
    <title>Planilha do C.R.C - Deletar Estado</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form1" class="col s12" action="save-estado.php?id=<?php echo $_GET['id'];?>" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Deletar Estado</h3>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s3">
                    <input type="text" name="nome" disabled value="<?php echo EstadoQuery::create()->findOneById((int)$_GET['id'])->getNome();?>" class="nome">
