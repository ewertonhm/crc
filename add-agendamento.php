...
<head>
    ...
    <title>Planilha do C.R.C - Inserir Agendamento</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form" class="col s12" action="save-agendamento.php" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Inserir Agendamento</h3>
            </div>
            <div class="row">
