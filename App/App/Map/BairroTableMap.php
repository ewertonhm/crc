...
class BairroTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.App.Map.BairroTableMap';
     ...
     */
    const OM_CLASS = '\\App\\App\\Bairro';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.App.Bairro';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\App\\Bairro');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\App\Bairro) { // it's a model object
