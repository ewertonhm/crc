...
use App\App\Atendimento;
use App\App\AtendimentoQuery;
...
class AtendimentoTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.App.Map.AtendimentoTableMap';
     ...
     */
    const OM_CLASS = '\\App\\App\\Atendimento';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.App.Atendimento';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\App\\Atendimento');
    ...
    {
        $this->addRelation('Agendamento', '\\App\\App\\Agendamento', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':agendamento_id',
    1 => ':id',
        ...
        $this->addRelation('Bairro', '\\App\\App\\Bairro', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':bairro_id',
    1 => ':id',
        ...
        $this->addRelation('Cidade', '\\App\\App\\Cidade', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':cidade_id',
    1 => ':id',
        ...
        $this->addRelation('ContatoRelatedByContatoId', '\\App\\App\\Contato', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':contato_id',
    1 => ':id',
        ...
        $this->addRelation('ContatoRelatedByContratoId', '\\App\\App\\Contato', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':contrato_id',
    1 => ':id',
        ...
        $this->addRelation('Estado', '\\App\\App\\Estado', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':estado_id',
    1 => ':id',
        ...
        $this->addRelation('Motivo', '\\App\\App\\Motivo', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':motivo_id',
    1 => ':id',
        ...
        $this->addRelation('Solicitacao', '\\App\\App\\Solicitacao', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':solicitacao_id',
    1 => ':id',
        ...
        $this->addRelation('Tag', '\\App\\App\\Tag', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':tag_id',
    1 => ':id',
        ...
        $this->addRelation('Tipo', '\\App\\App\\Tipo', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':tipo_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\App\Atendimento) { // it's a model object
