...
class TipoTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.App.Map.TipoTableMap';
     ...
     */
    const OM_CLASS = '\\App\\App\\Tipo';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.App.Tipo';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\App\\Tipo');
        $this->setPackage('App.App');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('tipo_id_seq');
        // columns
  ...
  array (
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\App\Tipo) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(TipoTableMap::DATABASE_NAME);
            $criteria->add(TipoTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TipoTableMap::COL_ID) && $criteria->keyContainsValue(TipoTableMap::COL_ID) ) {
