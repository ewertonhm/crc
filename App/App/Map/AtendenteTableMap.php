...
use App\App\Atendente;
use App\App\AtendenteQuery;
...
class AtendenteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.App.Map.AtendenteTableMap';
     ...
     */
    const OM_CLASS = '\\App\\App\\Atendente';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.App.Atendente';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\App\\Atendente');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\App\Atendente) { // it's a model object
