...
class TagTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.App.Map.TagTableMap';
     ...
     */
    const OM_CLASS = '\\App\\App\\Tag';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.App.Tag';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(TagTableMap::COL_ID, TagTableMap::COL_TAG, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(TagTableMap::COL_ID => 0, TagTableMap::COL_TAG => 1, ),
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\App\Tag) { // it's a model object
