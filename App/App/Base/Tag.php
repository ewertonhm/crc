...
abstract class Tag implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\App\\Map\\TagTableMap';
    ...
    /**
     * Initializes internal state of App\App\Base\Tag object.
     */
     ...
     * @return $this|\App\App\Tag The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\App\\Tag'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\App\Tag The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\App\Tag (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\App\Tag Clone of current object.
     * @throws PropelException
     */
    ...
    public function setAtendimentos(Collection $atendimentos, ConnectionInterface $con = null)
    {
        ...
        foreach ($atendimentosToDelete as $atendimentoRemoved) {
            $atendimentoRemoved->setTag(null);
        }
