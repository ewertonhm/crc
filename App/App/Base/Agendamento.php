...
abstract class Agendamento implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\App\\Map\\AgendamentoTableMap';
    ...
    /**
     * Initializes internal state of App\App\Base\Agendamento object.
     */
     ...
     * @return $this|\App\App\Agendamento The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = AgendamentoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\App\\Agendamento'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\App\Agendamento
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\App\Agendamento The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\App\Agendamento (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\App\Agendamento Clone of current object.
     * @throws PropelException
     */
