...
abstract class Atendente implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\App\\Map\\AtendenteTableMap';
    ...
    /**
     * Initializes internal state of App\App\Base\Atendente object.
     */
     ...
     * @return $this|\App\App\Atendente The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 5; // 5 = AtendenteTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\App\\Atendente'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\App\Atendente The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\App\Atendente (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\App\Atendente Clone of current object.
     * @throws PropelException
     */
