 ...
 */
abstract class Solicitacao implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\App\\Map\\SolicitacaoTableMap';
    ...
    /**
     * The value for the solicitacao field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of App\App\Base\Solicitacao object.
     */
    ...
    /**
     * Compares this with another <code>Solicitacao</code> instance.  If
     * <code>obj</code> is an instance of <code>Solicitacao</code>, delegates to
     * <code>equals(Solicitacao)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Solicitacao The current object, for fluid interface
     */
    ...
    /**
     * Get the [solicitacao] column value.
     *
     * @return string
     */
     ...
     * @return $this|\App\App\Solicitacao The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SolicitacaoTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [solicitacao] column.
     *
     * @param string $v new value
     * @return $this|\App\App\Solicitacao The current object (for fluent API support)
     */
    public function setSolicitacao($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->solicitacao !== $v) {
            $this->solicitacao = $v;
            $this->modifiedColumns[SolicitacaoTableMap::COL_SOLICITACAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SolicitacaoTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SolicitacaoTableMap::translateFieldName('Solicitacao', TableMap::TYPE_PHPNAME, $indexType)];
            $this->solicitacao = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = SolicitacaoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\App\\Solicitacao'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSolicitacaoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Solicitacao::setDeleted()
     * @see Solicitacao::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSolicitacaoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SolicitacaoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[SolicitacaoTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SolicitacaoTableMap::COL_ID . ')');
        }
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('solicitacao_id_seq')");
        ...
        if ($this->isColumnModified(SolicitacaoTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(SolicitacaoTableMap::COL_SOLICITACAO)) {
            $modifiedColumns[':p' . $index++]  = 'solicitacao';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'solicitacao':
                        $stmt->bindValue($identifier, $this->solicitacao, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = SolicitacaoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Solicitacao'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Solicitacao'][$this->hashCode()] = true;
        $keys = SolicitacaoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getSolicitacao(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\App\Solicitacao
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setSolicitacao($arr[$keys[1]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\App\Solicitacao The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(SolicitacaoTableMap::DATABASE_NAME);

        if ($this->isColumnModified(SolicitacaoTableMap::COL_ID)) {
            $criteria->add(SolicitacaoTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SolicitacaoTableMap::COL_SOLICITACAO)) {
            $criteria->add(SolicitacaoTableMap::COL_SOLICITACAO, $this->solicitacao);
        }
    ...
    {
        $criteria = ChildSolicitacaoQuery::create();
        $criteria->add(SolicitacaoTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\App\Solicitacao (or compatible) type.
    ...
    {
        $copyObj->setSolicitacao($this->getSolicitacao());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\App\Solicitacao Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSolicitacao is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSolicitacao The current object (for fluent API support)
     */
    public function setAtendimentos(Collection $atendimentos, ConnectionInterface $con = null)
    {
        ...
        foreach ($atendimentosToDelete as $atendimentoRemoved) {
            $atendimentoRemoved->setSolicitacao(null);
        }
    ...
    public function removeAtendimento(ChildAtendimento $atendimento)
    {
        if ($this->getAtendimentos()->contains($atendimento)) {
            ...
            $atendimento->setSolicitacao(null);
        }
    ...
    {
        return (string) $this->exportTo(SolicitacaoTableMap::DEFAULT_STRING_FORMAT);
    }
