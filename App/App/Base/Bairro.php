...
/**
 * Base class that represents a row from the 'bairro' table.
 *
 *
 *
 * @package    propel.generator.App.App.Base
 */
abstract class Bairro implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\App\\Map\\BairroTableMap';
    ...
    /**
     * Initializes internal state of App\App\Base\Bairro object.
     */
    ...
    /**
     * Compares this with another <code>Bairro</code> instance.  If
     * <code>obj</code> is an instance of <code>Bairro</code>, delegates to
     * <code>equals(Bairro)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Bairro The current object, for fluid interface
     */
     ...
     * @return $this|\App\App\Bairro The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BairroTableMap::COL_ID] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[BairroTableMap::COL_NOME] = true;
        }
    ...
    public function setCidadeId($v)
    {
        ...
        if ($this->cidade_id !== $v) {
            $this->cidade_id = $v;
            $this->modifiedColumns[BairroTableMap::COL_CIDADE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BairroTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BairroTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\App\\Bairro'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBairroQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Bairro::setDeleted()
     * @see Bairro::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBairroQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BairroTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('bairro_id_seq')");
        ...
        if ($this->isColumnModified(BairroTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(BairroTableMap::COL_NOME)) {
    ...
    {
        $pos = BairroTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Bairro'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Bairro'][$this->hashCode()] = true;
        $keys = BairroTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNome(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\App\Bairro The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BairroTableMap::COL_ID)) {
            $criteria->add(BairroTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(BairroTableMap::COL_NOME)) {
            $criteria->add(BairroTableMap::COL_NOME, $this->nome);
        }
        if ($this->isColumnModified(BairroTableMap::COL_CIDADE_ID)) {
    ...
    {
        $criteria = ChildBairroQuery::create();
        $criteria->add(BairroTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\App\Bairro (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\App\Bairro Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildBairro is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildBairro The current object (for fluent API support)
     */
    public function setAtendimentos(Collection $atendimentos, ConnectionInterface $con = null)
    {
        ...
        foreach ($atendimentosToDelete as $atendimentoRemoved) {
            $atendimentoRemoved->setBairro(null);
        }
     ...
     * Otherwise if this Bairro is new, it will return
     * an empty collection; or if this Bairro has previously
     * been saved, it will retrieve related Atendimentos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Bairro.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aCidade) {
            $this->aCidade->removeBairro($this);
        }
        $this->id = null;
        $this->nome = null;
        $this->cidade_id = null;
    ...
    {
        return (string) $this->exportTo(BairroTableMap::DEFAULT_STRING_FORMAT);
    }
