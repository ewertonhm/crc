...
use \Exception;
use \PDO;
use App\App\Contrato as ChildContrato;
...
abstract class ContratoQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\App\Base\ContratoQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\App\\Contrato', $modelAlias = null)
    {
