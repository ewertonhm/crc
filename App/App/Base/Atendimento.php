...
use App\App\Tag as ChildTag;
use App\App\TagQuery as ChildTagQuery;
...
abstract class Atendimento implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\App\\Map\\AtendimentoTableMap';
    ...
    /**
     * Initializes internal state of App\App\Base\Atendimento object.
     */
     ...
     * @return $this|\App\App\Atendimento The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\App\\Atendimento'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\App\Atendimento
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\App\Atendimento The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\App\Atendimento (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\App\Atendimento Clone of current object.
     * @throws PropelException
     */
