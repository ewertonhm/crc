 ...
 *
 * @method     \App\App\AtendimentoQuery|\App\App\CidadeQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EstadoQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\App\Base\EstadoQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\App\\Estado', $modelAlias = null)
    {
     ...
     *
     * @param \App\App\Cidade|ObjectCollection $cidade the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEstadoQuery The current query, for fluid interface
     */
