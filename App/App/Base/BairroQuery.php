 ...
 *
 * @method     \App\App\CidadeQuery|\App\App\AtendimentoQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BairroQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\App\Base\BairroQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\App\\Bairro', $modelAlias = null)
    {
