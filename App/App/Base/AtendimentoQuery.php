 ...
 *
 * @method     \App\App\AgendamentoQuery|\App\App\BairroQuery|\App\App\CidadeQuery|\App\App\ContatoQuery|\App\App\EstadoQuery|\App\App\MotivoQuery|\App\App\SolicitacaoQuery|\App\App\TagQuery|\App\App\TipoQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class AtendimentoQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\App\Base\AtendimentoQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\App\\Atendimento', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\App\Agendamento object
     *
     * @param \App\App\Agendamento|ObjectCollection $agendamento The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($agendamento instanceof \App\App\Agendamento) {
            return $this
            ...
            throw new PropelException('filterByAgendamento() only accepts arguments of type \App\App\Agendamento or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\App\AgendamentoQuery A secondary query class using the current class as primary query
     */
    public function useAgendamentoQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinAgendamento($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Agendamento', '\App\App\AgendamentoQuery');
    }

    /**
     * Filter the query by a related \App\App\Bairro object
     *
     * @param \App\App\Bairro|ObjectCollection $bairro The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    /**
     * Filter the query by a related \App\App\Cidade object
     *
     * @param \App\App\Cidade|ObjectCollection $cidade The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($cidade instanceof \App\App\Cidade) {
            return $this
            ...
            throw new PropelException('filterByCidade() only accepts arguments of type \App\App\Cidade or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\App\CidadeQuery A secondary query class using the current class as primary query
     */
    public function useCidadeQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCidade($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Cidade', '\App\App\CidadeQuery');
    }

    /**
     * Filter the query by a related \App\App\Contato object
     *
     * @param \App\App\Contato|ObjectCollection $contato The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($contato instanceof \App\App\Contato) {
            return $this
            ...
            throw new PropelException('filterByContatoRelatedByContatoId() only accepts arguments of type \App\App\Contato or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\App\ContatoQuery A secondary query class using the current class as primary query
     */
    public function useContatoRelatedByContatoIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'ContatoRelatedByContatoId', '\App\App\ContatoQuery');
    }
    ...
    public function filterByContatoRelatedByContratoId($contato, $comparison = null)
    {
        if ($contato instanceof \App\App\Contato) {
            ...
            throw new PropelException('filterByContatoRelatedByContratoId() only accepts arguments of type \App\App\Contato or Collection');
        }
    }
    ...
    public function useContatoRelatedByContratoIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'ContatoRelatedByContratoId', '\App\App\ContatoQuery');
    }
    ...
    /**
     * Filter the query by a related \App\App\Motivo object
     *
     * @param \App\App\Motivo|ObjectCollection $motivo The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($motivo instanceof \App\App\Motivo) {
            return $this
            ...
            throw new PropelException('filterByMotivo() only accepts arguments of type \App\App\Motivo or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\App\MotivoQuery A secondary query class using the current class as primary query
     */
    public function useMotivoQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinMotivo($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Motivo', '\App\App\MotivoQuery');
    }

    /**
     * Filter the query by a related \App\App\Solicitacao object
     *
     * @param \App\App\Solicitacao|ObjectCollection $solicitacao The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($solicitacao instanceof \App\App\Solicitacao) {
            return $this
            ...
            throw new PropelException('filterBySolicitacao() only accepts arguments of type \App\App\Solicitacao or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\App\SolicitacaoQuery A secondary query class using the current class as primary query
     */
    public function useSolicitacaoQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinSolicitacao($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Solicitacao', '\App\App\SolicitacaoQuery');
    }

    /**
     * Filter the query by a related \App\App\Tag object
     *
     * @param \App\App\Tag|ObjectCollection $tag The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByTag($tag, $comparison = null)
    {
        if ($tag instanceof \App\App\Tag) {
            ...
            throw new PropelException('filterByTag() only accepts arguments of type \App\App\Tag or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\App\TagQuery A secondary query class using the current class as primary query
     */
    public function useTagQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinTag($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Tag', '\App\App\TagQuery');
    }

    /**
     * Filter the query by a related \App\App\Tipo object
     *
     * @param \App\App\Tipo|ObjectCollection $tipo The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($tipo instanceof \App\App\Tipo) {
            return $this
            ...
            throw new PropelException('filterByTipo() only accepts arguments of type \App\App\Tipo or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\App\TipoQuery A secondary query class using the current class as primary query
     */
    public function useTipoQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinTipo($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Tipo', '\App\App\TipoQuery');
    }
