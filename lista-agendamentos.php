...
<div class="container-fluid full-width">
    <div class="tableFixHead">
        ...
        <table id="lista" class="table table-hover table-striped table-dark">
            ...
            <tbody>
                <?php
                    $dados = AgendamentoQuery::create()->orderById()->find();
                    foreach ($dados as $d){
                        $table1 = '';
                        $table2 = '';
                        ...
                        echo "
                            <tr>
                                ...
                                <td><a href='del-agendamento.php?id=".$table1."'><i class='small text-white material-icons'>clear</i></a></td>
                            </tr>
                        ";
                    }
                ?>
    ...
    <div class="fixed-action-btn">
        <a class="btn-floating btn-large green" href="add-agendamento.php">
