...
<head>
    ...
    <title>Planilha do C.R.C - Inserir Estado</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form" class="col s12" action="save-estado.php" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Inserir estado</h3>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s3">
                    <input type="text" name="form2" class="form1" required>
