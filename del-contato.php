...
<head>
    ...
    <title>Planilha do C.R.C - Deletar Contato</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form1" class="col s12" action="save-contato.php?id=<?php echo $_GET['id'];?>" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Deletar Contato</h3>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s3">
                    <input type="text" name="nome" disabled value="<?php echo ContatoQuery::create()->findOneById((int)$_GET['id'])->getContato();?>" class="nome">
