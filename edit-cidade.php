<?php
    ...
    require_once 'config.php';
    $dados = CidadeQuery::create()->findOneById((int)$_GET['id']);
?>
...
<head>
    ...
    <title>Planilha do C.R.C - Editar Cidade</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form1" class="col s12" action="save-cidade.php?id=<?php echo $dados->getId();?>" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Editar Cidade</h3>
            </div>
            <div class="row">
                    ...
                    <select name='form3'>
                        <?php
                            ...
                            foreach ($estados as $estado){
                                ...
                                if($dados->getEstadoId() == $estado->getId()){
                                    echo "selected";
                                }
                                echo ">".$estado->getUf()."</option>";
                            }
                        ?>
                    </select>
