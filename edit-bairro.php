<?php
    ...
    require_once 'config.php';
    $dados = BairroQuery::create()->findOneById((int)$_GET['id']);
?>
...
<head>
    ...
    <title>Planilha do C.R.C - Editar Bairro</title>
</head>
<body>
...
<div class="row">
    <form autocomplete="off" name="form1" class="col s12" action="save-bairro.php?id=<?php echo $dados->getId();?>" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Editar Bairro</h3>
            </div>
            <div class="row">
                    ...
                    <select name='form3'>
                        <?php
                            ...
                            foreach ($cidades as $cidade){
                                ...
                                if($dados->getCidadeId() == $cidade->getId()){
                                    echo "selected";
                                }
                                echo ">".$cidade->getNome()."</option>";
                            }
                        ?>
                    </select>
