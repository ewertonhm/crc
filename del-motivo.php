...
<head>
    ...
    <title>Planilha do C.R.C - Deletar Motivo</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form1" class="col s12" action="save-motivo.php?id=<?php echo $_GET['id'];?>" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Deletar Motivo</h3>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s3">
                    <input type="text" name="nome" disabled value="<?php echo MotivoQuery::create()->findOneById((int)$_GET['id'])->getMotivo();?>" class="nome">
