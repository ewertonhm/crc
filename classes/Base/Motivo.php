...
abstract class Motivo implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MotivoTableMap';
    ...
    /**
     * Initializes internal state of Base\Motivo object.
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Motivo (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Motivo Clone of current object.
     * @throws PropelException
     */
