...
abstract class Contrato implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ContratoTableMap';
    ...
    public function setDesabilitado($v)
    {
        ...
        if ($this->desabilitado !== $v) {
            $this->desabilitado = $v;
            $this->modifiedColumns[ContratoTableMap::COL_DESABILITADO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContratoTableMap::translateFieldName('Desabilitado', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ContratoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Contrato'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ContratoTableMap::COL_DESABILITADO)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContratoTableMap::COL_DESABILITADO)) {
            $criteria->add(ContratoTableMap::COL_DESABILITADO, $this->desabilitado);
        }
