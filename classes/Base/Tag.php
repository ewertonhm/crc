...
abstract class Tag implements ActiveRecordInterface
{
    ...
    public function setDesabilitado($v)
    {
        ...
        if ($this->desabilitado !== $v) {
            $this->desabilitado = $v;
            $this->modifiedColumns[TagTableMap::COL_DESABILITADO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TagTableMap::translateFieldName('Desabilitado', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_DESABILITADO)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_DESABILITADO)) {
            $criteria->add(TagTableMap::COL_DESABILITADO, $this->desabilitado);
        }
