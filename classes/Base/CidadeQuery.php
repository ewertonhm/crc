 ...
 *
 * @method     \EstadoQuery|\AtendimentoQuery|\BairroQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CidadeQuery extends ModelCriteria
{
     ...
     *
     * @param \Bairro|ObjectCollection $bairro the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCidadeQuery The current query, for fluid interface
     */
