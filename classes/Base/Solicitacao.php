...
abstract class Solicitacao implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SolicitacaoTableMap';
    ...
    /**
     * Initializes internal state of Base\Solicitacao object.
     */
     ...
     * @return $this|\Solicitacao The current object (for fluent API support)
     */
    ...
    public function setDesabilitado($v)
    {
        ...
        if ($this->desabilitado !== $v) {
            $this->desabilitado = $v;
            $this->modifiedColumns[SolicitacaoTableMap::COL_DESABILITADO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SolicitacaoTableMap::translateFieldName('Desabilitado', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SolicitacaoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Solicitacao'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SolicitacaoTableMap::COL_DESABILITADO)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SolicitacaoTableMap::COL_DESABILITADO)) {
            $criteria->add(SolicitacaoTableMap::COL_DESABILITADO, $this->desabilitado);
        }
