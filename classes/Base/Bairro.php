...
abstract class Bairro implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BairroTableMap';
    ...
    /**
     * Initializes internal state of Base\Bairro object.
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Bairro (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Bairro Clone of current object.
     * @throws PropelException
     */
