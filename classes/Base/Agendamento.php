 ...
 */
abstract class Agendamento implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\AgendamentoTableMap';
    ...
    /**
     * The value for the agendamento field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Base\Agendamento object.
     */
    ...
    /**
     * Compares this with another <code>Agendamento</code> instance.  If
     * <code>obj</code> is an instance of <code>Agendamento</code>, delegates to
     * <code>equals(Agendamento)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Agendamento The current object, for fluid interface
     */
    ...
    /**
     * Get the [agendamento] column value.
     *
     * @return string
     */
     ...
     * @return $this|\Agendamento The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AgendamentoTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [agendamento] column.
     *
     * @param string $v new value
     * @return $this|\Agendamento The current object (for fluent API support)
     */
    public function setAgendamento($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->agendamento !== $v) {
            $this->agendamento = $v;
            $this->modifiedColumns[AgendamentoTableMap::COL_AGENDAMENTO] = true;
        }
    ...
    public function setDesabilitado($v)
    {
        ...
        if ($this->desabilitado !== $v) {
            $this->desabilitado = $v;
            $this->modifiedColumns[AgendamentoTableMap::COL_DESABILITADO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AgendamentoTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AgendamentoTableMap::translateFieldName('Agendamento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->agendamento = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AgendamentoTableMap::translateFieldName('Desabilitado', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = AgendamentoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Agendamento'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAgendamentoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Agendamento::setDeleted()
     * @see Agendamento::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAgendamentoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AgendamentoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AgendamentoTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AgendamentoTableMap::COL_ID . ')');
        }
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('agendamento_id_seq')");
        ...
        if ($this->isColumnModified(AgendamentoTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AgendamentoTableMap::COL_AGENDAMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'agendamento';
        }
        if ($this->isColumnModified(AgendamentoTableMap::COL_DESABILITADO)) {
            $modifiedColumns[':p' . $index++]  = 'desabilitado';
        }

        $sql = sprintf(
            'INSERT INTO agendamento (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'agendamento':
                        $stmt->bindValue($identifier, $this->agendamento, PDO::PARAM_STR);
                        break;
                    case 'desabilitado':
    ...
    {
        $pos = AgendamentoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Agendamento'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Agendamento'][$this->hashCode()] = true;
        $keys = AgendamentoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getAgendamento(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setAgendamento($arr[$keys[1]]);
        }
    ...
    {
        $criteria = new Criteria(AgendamentoTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AgendamentoTableMap::COL_ID)) {
            $criteria->add(AgendamentoTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AgendamentoTableMap::COL_AGENDAMENTO)) {
            $criteria->add(AgendamentoTableMap::COL_AGENDAMENTO, $this->agendamento);
        }
        if ($this->isColumnModified(AgendamentoTableMap::COL_DESABILITADO)) {
            $criteria->add(AgendamentoTableMap::COL_DESABILITADO, $this->desabilitado);
        }
    ...
    {
        $criteria = ChildAgendamentoQuery::create();
        $criteria->add(AgendamentoTableMap::COL_ID, $this->id);
    ...
    {
        $copyObj->setAgendamento($this->getAgendamento());
     ...
     * If this ChildAgendamento is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAgendamento The current object (for fluent API support)
     */
    public function setAtendimentos(Collection $atendimentos, ConnectionInterface $con = null)
    {
        ...
        foreach ($atendimentosToDelete as $atendimentoRemoved) {
            $atendimentoRemoved->setAgendamento(null);
        }
    ...
    protected function doAddAtendimento(ChildAtendimento $atendimento)
    {
        ...
        $atendimento->setAgendamento($this);
    }
    ...
    public function removeAtendimento(ChildAtendimento $atendimento)
    {
        if ($this->getAtendimentos()->contains($atendimento)) {
            ...
            $atendimento->setAgendamento(null);
        }
     ...
     * Otherwise if this Agendamento is new, it will return
     * an empty collection; or if this Agendamento has previously
     * been saved, it will retrieve related Atendimentos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Agendamento.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(AgendamentoTableMap::DEFAULT_STRING_FORMAT);
    }
