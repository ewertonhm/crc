...
<head>
    ...
    <title>Planilha do C.R.C - Inserir Bairro</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form" class="col s12" action="save-bairro.php" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Inserir Bairro</h3>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s3">
                    <?php $formManager->selectForm(CidadeQuery::create()->find(),'getNome','form2') ?>
