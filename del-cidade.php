...
<head>
    ...
    <title>Planilha do C.R.C - Deletar Cidade</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form1" class="col s12" action="save-cidade.php?id=<?php echo $_GET['id'];?>" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Deletar Cidade</h3>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s3">
                    <input type="text" name="nome" disabled value="<?php echo CidadeQuery::create()->findOneById((int)$_GET['id'])->getNome();?>" class="nome">
