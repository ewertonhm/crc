...
<head>
    ...
    <title>Planilha do C.R.C - Cidades</title>
...
<div class="container-fluid full-width">
    <div class="tableFixHead">
        ...
        <table id="lista" class="table table-hover table-striped table-dark">
            ...
            <tbody>
                <?php
                    $dados = CidadeQuery::create()->orderByNome()->find();
                    foreach ($dados as $d){
                        $table1 = '';
                        $table2 = '';
                        $table3 = '';
                        ...
                        echo "
                            <tr>
                                ...
                                <td>".$table2."</td>
                                <td>".$table3."</td>
                                <td><a href='edit-cidade.php?id=".$table1."'><i class='small text-white material-icons'>edit</i></a></td>
                                <td><a href='del-cidade.php?id=".$table1."'><i class='small text-white material-icons'>delete</i></a></td>
                            </tr>
                        ";
                    }
                ?>
    ...
    <div class="fixed-action-btn">
        <a class="btn-floating btn-large green" href="add-cidade.php">
