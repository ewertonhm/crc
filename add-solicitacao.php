...
<head>
    ...
    <title>Planilha do C.R.C - Inserir Solicitação</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form" class="col s12" action="save-solicitacao.php" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Inserir Solicitação</h3>
            </div>
            <div class="row">
