...
<head>
    ...
    <title>Planilha do C.R.C - Inserir Contrato</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form" class="col s12" action="save-contrato.php" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Inserir Contrato</h3>
            </div>
            <div class="row">
