<?php
    ...
    require_once 'config.php';
    $dados = SolicitacaoQuery::create()->findOneById((int)$_GET['id']);
?>
...
<head>
    ...
    <title>Planilha do C.R.C - Editar Solicitacao</title>
</head>
<body>

<div class="row">
    <form autocomplete="off" name="form1" class="col s12" action="save-solicitacao.php?id=<?php echo $dados->getId();?>" method="post">
        <div class="col s12">
            <div class="row ">
                <h3 class="green-text">Editar Solicitacao</h3>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col s3">
                    <input type="text" name="form2" class="nome" value="<?php echo $dados->getSolicitacao();?>">
